...
var _RecordHomeSingleColNoHeaderTemplateDesktop2 = require('salesforce-pageobjects/flexipage/pageObjects/recordHomeSingleColNoHeaderTemplateDesktop2');
var _Component2 = require('salesforce-pageobjects/flexipage/pageObjects/component2');
var _FieldSection2 = require('salesforce-pageobjects/flexipage/pageObjects/fieldSection2');
var _RecordField = require('salesforce-pageobjects/record/flexipage/pageObjects/recordField');
var _RecordPicklist = require('salesforce-pageobjects/records/pageObjects/recordPicklist');
...
async function _utam_get_recordHome(driver, root) {
    ...
    const _locator = core.By.css("flexipage-record-home-single-col-no-header-template-desktop2");
    return _element.findElement(_locator);
}
...
async function _utam_get_fieldSectionss(driver, root) {
    let _element = await _utam_get_actionBody(driver, root);
    const _locator = core.By.css("flexipage-field-section2");
    return _element.findElements(_locator);
}

async function _utam_get_fieldSectionByIndex(driver, root, sectionIndex) {
    let _element = await _utam_get_actionBody(driver, root);
    const _locator = core.By.css("flexipage-field-section2:nth-of-type(" + sectionIndex + ")");
...
async function _utam_get_sectionRecordFieldss(driver, root, sectionIndex) {
    ...
    const _locator = core.By.css("record_flexipage-record-field");
    return _element.findElements(_locator);
}
...
async function _utam_get_fieldByApiName(driver, root, apiName) {
    let _element = await _utam_get_actionBody(driver, root);
    const _locator = core.By.css("record_flexipage-record-field div[data-target-selection-name=\"" + apiName + "\"]");
    const hasElement = await _element.containsElement(_locator);
    if (!hasElement) { return null; }
    return _element.findElement(_locator);
}
...
async function _utam_get_picklistByApiName(driver, root, apiName) {
    let _element = await _utam_get_actionBody(driver, root);
    const _locator = core.By.css("record_flexipage-record-field div[data-target-selection-name=\"" + apiName + "\"] [slot=\"input\"] records-record-picklist");
    const hasElement = await _element.containsElement(_locator);
    if (!hasElement) { return null; }
    return _element.findElement(_locator);
}
 ...
 * @author UTAM
 */
class FlexipageFieldExplorer extends core.UtamBaseRootPageObject {
    ...
    async getRecordHome() {
        ...
        element = await core.createInstance(_RecordHomeSingleColNoHeaderTemplateDesktop2, driver, element);
    ...
    async getComponents() {
        ...
        elements = await Promise.all(elements.map(function _createElement(element) {
                    return core.createInstance(_Component2, driver, element);
                }));
    ...
    async getFieldSections() {
        ...
        elements = await Promise.all(elements.map(function _createElement(element) {
                    return core.createInstance(_FieldSection2, driver, element);
                }));
        await Promise.all(elements.map(el => el.__beforeLoad__()));
        return elements;
    }
    ...
    async getSectionRecordFields(sectionIndex) {
        ...
        elements = await Promise.all(elements.map(function _createElement(element) {
                    return core.createInstance(_RecordField, driver, element);
                }));
        await Promise.all(elements.map(el => el.__beforeLoad__()));
        return elements;
    }
    ...
    async getPicklistByApiName(apiName) {
        ...
        if (!element) { return null; }
        element = await core.createInstance(_RecordPicklist, driver, element);
        await element.__beforeLoad__();
        return element;
    }
...
module.exports = FlexipageFieldExplorer;
