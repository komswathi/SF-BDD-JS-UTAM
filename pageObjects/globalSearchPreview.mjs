...
async function _utam_get_recordLink(driver, root) {
    let _element = root;
    const _locator = _By.css("a[data-refid='recordId']");
 ...
 * @author UTAM
 */
export default class GlobalSearchPreview extends _UtamBaseRootPageObject {
    constructor(driver, element, locator = _By.css("#preview")) {
