...
import { By as _By, createUtamMixinCtor as _createUtamMixinCtor, UtamBaseRootPageObject as _UtamBaseRootPageObject, ClickableUtamElement as _ClickableUtamElement, ActionableUtamElement as _ActionableUtamElement } from '@utam/core';

async function _utam_get_searchButton(driver, root) {
    let _element = root;
    const _locator = _By.css("button.search-button[aria-label='Search']");
 ...
 * @author UTAM
 */
export default class GlobalHeader extends _UtamBaseRootPageObject {
    constructor(driver, element, locator = _By.css(".oneHeader")) {
